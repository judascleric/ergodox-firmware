...
KB_MATRIX_LAYER(
	...
	KEY_LeftAlt,	KEY_q_Q,	KEY_w_W,	KEY_f_F,	KEY_p_P,	KEY_g_G,	KEY_Equal_Plus,	
	KEY_LeftShift,	KEY_a_A,	KEY_r_R,	KEY_s_S,	KEY_t_T,	KEY_d_D,	
	KEY_LeftControl,	KEY_z_Z,	KEY_x_X,	KEY_c_C,	KEY_v_V,	KEY_b_B,	0,	
	KEY_Home,	KEY_End,	KEY_PageUp,	KEY_PageDown,	1,
	KEY_Tab,	KEY_Spacebar,	
	0,	0,	KEY_ReturnEnter,	
	KEY_Escape,	2,	KEY_LeftGUI,	
	// right hand
	...
	KEY_Application,	KEY_j_J,	KEY_l_L,	KEY_u_U,	KEY_y_Y,	KEY_Semicolon_Colon,	KEY_RightAlt,	
	KEY_h_H,	KEY_n_N,	KEY_e_E,	KEY_i_I,	KEY_o_O,	KEY_RightShift,	
	KEY_F13,	KEY_k_K,	KEY_m_M,	KEY_Comma_LessThan,	KEY_Period_GreaterThan,	KEY_Slash_Question,	KEY_RightControl,	
...
KB_MATRIX_LAYER(
	...
	MEDIAKEY_NEXT_TRACK, MEDIAKEY_VOL_DN,  MEDIAKEY_VOL_UP,  MEDIAKEY_PLAY_PAUSE,	0,	
	0,	0,	
	0,	0,	0,	
	0,	0,	0,	
	// right hand
...
KB_MATRIX_LAYER(
	...
	// left hand
	0,	0,	0,	0,	0,	0,	0,	
	0,	KEY_F11,	KEY_F12,	KEYPAD_Plus,	KEYPAD_Period_Delete,	KEY_Comma_LessThan,	0,	
	0,	KEYPAD_1_End,	KEYPAD_2_DownArrow,	KEYPAD_3_PageDown,	KEYPAD_4_LeftArrow,	KEYPAD_5,	
	...
	// right hand
	0,	0,	0,	0,	0,	0,	0,	
	0,	KEY_Mute,	KEYPAD_Slash,	KEYPAD_Asterisk,	KEYPAD_Minus,	KEY_Equal_Plus,	0,	
	KEYPAD_6_RightArrow,	KEYPAD_7_Home,	KEYPAD_8_UpArrow,	KEYPAD_9_PageUp,	KEYPAD_0_Insert,	0,	
...
KB_MATRIX_LAYER(
	...
	mprrel,	mprrel,	mprrel,	mprrel,	ktrans,	
	ktrans,	ktrans,	
	NULL,	NULL,	ktrans,	
